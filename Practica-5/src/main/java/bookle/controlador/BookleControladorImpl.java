...
public class BookleControladorImpl implements BookleControlador {
	...
	@Override
	public String createActividad(String titulo, String descripcion, String profesor, String email) throws BookleException, IllegalArgumentException {
		
        if (titulo == null || titulo.equals(""))
            throw new IllegalArgumentException("El titulo no puede ser nulo o vacio");

        if (profesor == null || profesor.equals(""))
            throw new IllegalArgumentException("El nombre del profesor no puede ser nulo o vacio");
	...
	@Override
	public void updateActividad(String id, String titulo, String descripcion, String profesor, String email) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	@Override
	public Actividad getActividad(String id) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	@Override
	public boolean removeActividad(String id) throws BookleException, IllegalArgumentException {
	...
	@Override
	public void addDiaActividad(String id, Date fecha, int turnos)	throws BookleException, IllegalArgumentException {
        ...
        if (fecha == null) 
        	throw new IllegalArgumentException("La fecha no pueda ser nula");
	...
	@Override
	public boolean removeDiaActividad(String id, Date fecha) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	public void removeTurnoActividad(String id, Date fecha, int turno) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	public void setHorario(String id, Date fecha, int indice, String horario)
        ...
        if (indice < 1)
        	throw new IllegalArgumentException("El turno no puede ser menor de 1");
	...
	@Override
	public String createReserva(String id, Date fecha, int indice, String alumno, String email) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	@Override
	public boolean removeReserva(String id, String ticket) throws BookleException, IllegalArgumentException, RecursoNoEncontradoException {
	...
	@Override
	public Collection<String> getIdentifidores() {
